function About() {
    return (
        <div className="relative">
            <div className="flex">
                {/* Left Panel */}
                <div className="bg-[#fae5d3] w-1/4 h-150"></div>
                ...
                <div className="bg-white w-full m-10 ml-10 p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <button className="text-black border px-8 py-2 rounded-3xl hover:bg-green-700">
                            PROJECTS
                        </button>
                    </div>
            ...
            <div className="absolute top-10 left-40 lg:left-20 bg-[#fae3d1] w-[200px] h-[250px] 
                ...
                <div className="flex justify-center gap-3 mt-6 bg-white p-2 mt-14 w-[200px]">
                    <img src="/icons/gmail.png" alt="Mail" className="w-6 h-6" />
                    <img src="/icons/linkedin.png" alt="LinkedIn" className="w-6 h-6" />
                    <img src="/icons/social.png" alt="Social" className="w-6 h-6" />
